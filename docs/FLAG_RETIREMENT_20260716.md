...
live in `configs/generation/coherent_public_n128.schema17.json`.
...
`configs/eval/coherent_public_n128.schema17.json`.

```bash
python tools/evaluate.py \
  --config configs/eval/coherent_public_n128.schema17.json \
