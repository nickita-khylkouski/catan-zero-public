...
def _run(seed: int, policy: dict[int, float], **cost) -> dict:
    ...
    return {
        ...
        "neural_evaluation_rows": cost.get("neural_evaluation_rows", 111),
        "unique_leaf_expansions": cost.get("unique_leaf_expansions", 100),
        "unique_boundary_expansions": cost.get("unique_boundary_expansions", 0),
