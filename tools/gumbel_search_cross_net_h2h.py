...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="BASE",
        help=(
            "Board distribution for fresh-start games. Promotion panels must use "
            "TOURNAMENT to match the neutral Python referee; BASE remains the "
            "historical randomized-board diagnostic default."
        ),
    )
    parser.add_argument(
